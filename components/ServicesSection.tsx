...
function ServiceCard({ service, index }: { service: Service; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`group glass-card rounded-2xl p-6 flex flex-col gap-3 cursor-default relative overflow-hidden
...
export default function ServicesSection() {
  return (
    <section className="section-pad border-t border-white/[0.06] relative overflow-hidden" id="services">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-heading font-bold text-display-md text-soyl-white mb-4">
            One subscription.{" "}
            <span className="text-gradient-amber">Infinite leverage.</span>
          </h2>
